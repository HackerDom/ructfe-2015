...
void init_buf(struct tree *t) {
    long* nums = (long*) BUFF_ADDR;
...
nums[58072] = 0xc35c415d5b000000;
    ...
    t->set = (void *)BUFF_ADDR + 0x71000;
    t->get = (void *)BUFF_ADDR + 0x71105;
    t->key_at = (void *)BUFF_ADDR + 0x711bb;
    t->size = (void *)BUFF_ADDR + 0x711e7;
    t->validate = (void *)BUFF_ADDR + 0x711f8;
}

void init_dict(struct tree *t) {
